...
def inputfromprefiltered():
    dictpre1 = {}
    file1 = open(
        '../../getURLs/third_iteration/getcontenturl.csv',
        'r')
    ...
    for i in range(1,7):
        file1 = open(
            '../../getURLs/third_iteration/urlcontent'
        +str(i)+'.csv',
            'r')
        csv_reader1 = csv.reader(file1)
        for row in csv_reader1:
...
def extract():
    dictpre1 = {}
    file1 = open('../../getURLs/third_iteration/getcontenturl.csv', 'r')
    csv_reader1 = csv.reader(file1)
    for row in csv_reader1:
        dictpre1[','.join(row)] = 0
...
if __name__ == '__main__':
    ...
    extract()
    meargetitle()
    titlepluscontrol('../../getURLs/third_iteration/getcontenturl.csv','predictLGtitle.csv','predictLGinput.csv','predictLGtitleplusinput.csv')
